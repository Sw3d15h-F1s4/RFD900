...
void SDcard_Initilization()
{
  ...
  dataFile.println("PacketNumber,SIV,FixType,Latitude,Longitude,Altitude,Year,Month,Day,Hour,Min,Sec,NNV,NEV,NDV,Battery,3v3 Supply,5v Supply,Radio Supply,Analog Internal,Analog External,AltimeterTemp,Digital Internal,Digital External,Pressure,Accel A,Accel Y,AccelZ,Pitch,Roll,Yaw");
  dataFile.close();
...
void Store_Data()
{
  ...
  { // Write our data to the csv file
    dataFile.print(String(packet) + "," + String(SIV) + "," + String(FixType) + "," + String(latitude) + ",");
    dataFile.print(String(longitude) + "," + String(altitude) + "," + String(year) + "," + String(month) + ",");
    dataFile.print(String(day) + "," + String(hour) + "," + String(minute) + ",");
    dataFile.print(String(sec) + "," + String(NedNorthVel) + "," + String(NedEastVel) + "," + String(NedDownVel) + ",");
    dataFile.print(String(Bat) + "," + String(t3v3) + "," + String(f5v) + "," + String(f5vI) + "," + String(Aint) + "," + String(Aext) + "," + String(Pres_Temp) + "," + String(Dint) + "," + String(Dext));
    dataFile.println("," + String(pressure) + "," + String(Acceleration_X) + "," + String(Acceleration_Y) + "," + String(Acceleration_Z) + "," + String(Pitch) + "," + String(Roll) + "," + String(Yaw));
    dataFile.close();
  }
